...
---
First, let's take a look at our generator.
(inspect)
the maintenance will always wear down over time, the longer we neglect it the more work it will take to make it run smoothly again, and the more likely it is to be first damaged and eventually break completely.
...
if a unit breaks, the fish and plants will die.
since we can't  go out to get more, if we lose all fish we lose the farm.
